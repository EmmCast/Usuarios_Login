...
🧾 Descripción Usuarios_Login es un sistema backend desarrollado en Spring Boot 3 que permite la gestión segura de usuarios, incluyendo autenticación con contraseña encriptada (BCrypt), asignación de roles, carga de fotos de perfil y funcionalidades extendibles como preguntas de seguridad.
...
📷 Visuales (opcional) Se agregara captura posteriormente

🧑‍💻 Autor Proyecto desarrollado por: EmmCast91